...
<img src="asstets/output.webp" style="max-width: 60%; margin-top:15px; height: 60%; margin-bottom: 15px;" alt="Output Chart" />

- The Word Cloud analysis highlights frequent terms like "Dodgers," "avenged," and "team," reflecting discussions on rivalries, game outcomes, and fan emotions.
- Themes such as team rivalries, sentiments, and camaraderie emerge, with words like "love," "hate," and "champions" indicating polarized fan reactions.
- Sentiment correlation shows positive (e.g., "win"), negative (e.g., "hate"), and neutral (e.g., "team") terms shaping discussions.
- Insights aid marketing, content creation, and event planning by aligning strategies with fan narratives.

<img src="asstets/output-bar.png" style="max-width: 60%; margin-top: 10px; margin-bottom: 15px; height: 60%;" alt="Output Bar Chart" />
